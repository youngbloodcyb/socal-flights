export default function Input() {
    return (
        <div className="flex flex-row mt-4  w-full">
            ...
            <button className="text-sm px-6 border border-white rounded-md ml-4 text-gray-400 hover:text-white hover:text-base transition-all duration-300 ease-in-out">Sign Up</button>
        </div>
    )
}
